        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                ...
                <form action="${pageContext.request.contextPath}/healthWorkerLoginServlet" method="post">
                    <!-- User Name -->
                    <div class="mb-3">
                        <label for="userName" class="form-label">Heath Worker Id</label>
                        <input type="text" class="form-control" id="healthId" name="healthId" placeholder="Enter your name" required>
                    </div>
